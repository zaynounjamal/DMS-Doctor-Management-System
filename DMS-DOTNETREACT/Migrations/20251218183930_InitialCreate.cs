        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfilePhoto = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OffDays_Users_CreatedByUser",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PatientId = table.Column<int>(type: "int", nullable: false),
                    AssignedSecretaryId = table.Column<int>(type: "int", nullable: true),
                    Status = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ChatConversations_Secretaries_AssignedSecretaryId",
                        column: x => x.AssignedSecretaryId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SecretaryAvailabilities", x => x.SecretaryId);
                    table.ForeignKey(
                        name: "FK_SecretaryAvailabilities_Secretaries_SecretaryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Payments_Secretaries_SecretaryId",
                        column: x => x.SecretaryId,
                        principalTable: "Secretaries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "\r\n                    <h3>Welcome, {{FullName}}!</h3>\r\n                    <p>Thank you for registering with us. We are excited to have you on board.</p>\r\n                    <p>Your username is: <strong>{{UserName}}</strong></p>\r\n                    <br/>\r\n                    <p>Best Regards,</p>\r\n                    <p>The Clinic Team</p>", "Sent to new users upon registration.", new DateTime(2025, 12, 18, 18, 39, 28, 809, DateTimeKind.Utc).AddTicks(9576), "WelcomeEmail", "Welcome to Our Clinic!" },
                    { 2, "\r\n                    <h3>Appointment Reminder</h3>\r\n                    <p>Dear {{FullName}},</p>\r\n                    <p>This is a reminder for your upcoming appointment.</p>\r\n                    <p><strong>Date:</strong> {{Date}}</p>\r\n                    <p><strong>Time:</strong> {{Time}}</p>\r\n                    <p><strong>Doctor:</strong> {{DoctorName}}</p>\r\n                    <br/>\r\n                    <p>Please contact us if you need to reschedule.</p>\r\n                    <p>The Clinic Team</p>", "Automated reminder sent 1 day before appointment.", new DateTime(2025, 12, 18, 18, 39, 28, 810, DateTimeKind.Utc).AddTicks(2196), "AppointmentReminder", "Appointment Reminder" }
                });
