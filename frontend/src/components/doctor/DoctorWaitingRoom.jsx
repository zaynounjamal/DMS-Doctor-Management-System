            ...
            {patients.length === 0 ? (
                <div className="p-12 text-center">
                    <div className="w-16 h-16 bg-gray-50 rounded-full flex items-center justify-center mx-auto mb-4">
                        <User color="#9333ea" size={32} />
                    </div>
                    <h3 className="text-lg font-medium text-white">No patients waiting</h3>
                    <p className="text-gray-400 mt-1">Checked-in patients will appear here.</p>
                </div>
            ) : (
                <div className="divide-y divide-gray-800">
                    {patients.map((patient) => (
                        <div key={patient.id} className="p-6 hover:bg-white/5 transition-colors flex flex-col md:flex-row md:items-center justify-between gap-4">
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    <h3 className="font-bold text-white">{patient.patientName}</h3>
