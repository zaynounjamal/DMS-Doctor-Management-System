        ...
        <div style={{
            ...
            {patients.length === 0 ? (
                <div className="p-12 text-center">
                    ...
                    <p className="text-gray-600 mt-1">Checked-in patients will appear here.</p>
                </div>
            ) : (
                <div className="divide-y divide-gray-100">
                    {patients.map((patient) => (
                        <div key={patient.id} className="p-6 hover:bg-purple-50/50 transition-colors flex flex-col md:flex-row md:items-center justify-between gap-4">
